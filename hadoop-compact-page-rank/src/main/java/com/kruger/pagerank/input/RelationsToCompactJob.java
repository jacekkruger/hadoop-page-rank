...
public class RelationsToCompactJob {

	public static final String REQUIRED_PARAMS[] = { PageRank.DATA_PATH };

	protected static final Logger log = Logger.getLogger(RelationsToCompactJob.class);
	...
	public static Job createJob(Configuration conf) throws IOException {
		Job job = Job.getInstance(conf, "Relations to compact matrix");
		job.setJarByClass(RelationsToCompactJob.class);
		job.setMapperClass(Mapper.class);
		job.setReducerClass(RelationsToCompactReducer.class);
